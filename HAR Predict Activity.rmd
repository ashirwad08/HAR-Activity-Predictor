...
We'll split the dataset into our a train and test (cross validation) dataset. This'll ensure that the same features are used in training as well as during validation, while the model is trained **only** on the training set. 
...
Density plot:  
```{r densityPlot, message=FALSE, warning=FALSE, error=FALSE}
featurePlot(x = train[, 2:5],
                  y = train$classe,
                  plot = "density",
